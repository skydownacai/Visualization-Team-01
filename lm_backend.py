...
tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "获取用户的时间模式分析，包括答题高峰时段（按小时统计）和学习频率（每日提交次数）的数据与可视化图表。",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "获取用户的题型偏好分析，包括各题型（选择题/编程题）的正确率对比数据与可视化图表。",
            "parameters": {
                "type": "object",
                "properties": {
                    "start_dt": {"type": "string", "description": "开始日期,格式为YYYY-MM-DD"},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "获取用户的能力分布分析，包括知识掌握广度（覆盖知识点数）和深度（高难度题目正确率）的数据与可视化图表。",
            "parameters": {
                "type": "object",
                "properties": {
                    "start_dt": {"type": "string", "description": "开始日期,格式为YYYY-MM-DD"},
